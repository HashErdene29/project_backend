...
public class AuthServiceImpl implements AuthService {
    ...
    public LoginResponse login(LoginRequest loginRequest) {
        ...
        final int role_id = ((AwesomeUserDetails) userDetails).getRoleId();
        var loginResponse = new LoginResponse(accessToken, refreshToken, user_id, role_id);
    ...
    public LoginResponse refreshToken(RefreshTokenRequest refreshTokenRequest) {
        ...
        if (isRefreshTokenValid) {
            ...
            var loginResponse = new LoginResponse(accessToken, refreshTokenRequest.getRefreshToken(), 1, 3);
